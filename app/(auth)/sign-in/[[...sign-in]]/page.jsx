      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row flex-1 p-4 relative z-10">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start p-4 md:p-8">
          ...
          <div className="bg-yellow-200 px-3 py-1 mb-6 inline-block">
            <p className="text-lg sm:text-xl text-gray-800">Your personal journal for emotional well-being</p>
          </div>

          {/* Welcome message */}
          <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-100 max-w-md w-full">
            <h2 className="text-xl text-purple-700 font-medium mb-2">Dear Friend,</h2>
            ...
            <p className="text-gray-700">
              Write your thoughts, track your moods, and discover insights that help you understand yourself better.
              ...
              <SignIn
                appearance={{
                  elements: {
                    ...
                    formFieldInput: "border-gray-300 focus:border-purple-500 focus:ring-purple-400 w-full",
