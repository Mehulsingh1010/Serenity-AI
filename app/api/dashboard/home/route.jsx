  ...
  try {
    ...
    try {
      ...
      const resultPromise = model.generateContent({
        contents: [
          { role: "user", parts: [{ text: ANALYSIS_PROMPT + content }] },
        ],
        generationConfig: {
          temperature: 0.7,
      ...
      try {
        ...
        if (
          !analysis ||
          typeof analysis.moodScore !== "number" ||
          !analysis.summary
        ) {
      ...
      const fallbackAnalysis = {
        ...
        suggestions: {
          ...
          longTerm:
            "Continue journaling regularly as it's beneficial regardless of AI analysis.",
          activities: [
            "Take a short walk",
